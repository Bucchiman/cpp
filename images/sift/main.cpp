 ...
 * FileName:     main
 * Author:       8ucchiman
 * CreatedDate:  2023-04-25 23:00:24
 * LastModified: 2023-03-28 10:34:14 +0900
 * Reference:    https://github.com/shin0805/opencvIntro/blob/main/step6/main.cpp
 * Description:  ---
 */
...
int main() {
    ...
    cv::Ptr<cv::Feature2D> f2d = cv::SiftFeatureDetector::create();
